...
function Hero() {
  return (
   <div className='flex flex-col sm:flex-row md:flex-row lg:flex-row xl:flex-row justify-around py-[40px] max-w-[1300px] m-auto gap-5'>
    ...
    <div className=' max-w-[400px] h-fit bg-yellow-300 flex flex-col items-center rounded-lg p-[10px] gap-3'>
    ...
    <div>
    <div className=' max-w-[500px] bg-green-500 flex flex-col items-center rounded-lg p-[10px] gap-3'>
    ...
    <div>
    <div className=' max-w-[500px] h-fit bg-red-400 flex flex-col items-center rounded-lg p-[10px] gap-3'>
      <h1 className='text-xl text-white'>بازدید در این صفحه</h1>
